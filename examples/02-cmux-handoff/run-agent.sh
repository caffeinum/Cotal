...
exec env \
  ...
  ${SWARL_SERVERS:+SWARL_SERVERS="$SWARL_SERVERS"} \
  ${SWARL_NATS_TOKEN:+SWARL_NATS_TOKEN="$SWARL_NATS_TOKEN"} \
  ${SWARL_NATS_CREDS:+SWARL_NATS_CREDS="$SWARL_NATS_CREDS"} \
  ${SWARL_NATS_USER:+SWARL_NATS_USER="$SWARL_NATS_USER"} \
  ${SWARL_NATS_PASS:+SWARL_NATS_PASS="$SWARL_NATS_PASS"} \
  claude \
    --strict-mcp-config \
