...
5. **Offers a cmux session**: a Claude you drive, with david and sven helping in the
   ...
   focused `cotal-main` pane. With no cmux it shows the `cotal · ready` card instead. The
