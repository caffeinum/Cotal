...
// duplicated Claude Code. Seamless loop. 110+240+135+120 = 605f / 20s.

import React from "react";
import { AbsoluteFill, Series, loopEnvelope, useCurrentFrame } from "../header/shared";
import { S0Headline } from "./S0Headline";
import { S5TopologyVendorsCodex } from "./S5TopologyVendors";
  ...
  return (
    <AbsoluteFill style={{ opacity: loopEnvelope(frame, DURATION, 12) }}>
      <Series>
        ...
        <Series.Sequence durationInFrames={240}><S5TopologyVendorsCodex /></Series.Sequence>
